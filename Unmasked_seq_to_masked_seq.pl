...
my $Unmasked_read_file = $dir."/".$SampleName.".RepeatMasker.goodSeq.RefGenome.unmapped.unmasked.fasta";
my @Unmasked_read = ();
# get read ID
...
my $OutFile1 = $dir."/".$SampleName.".RepeatMasker.goodSeq.RefGenome.unmapped.masked.fasta";
